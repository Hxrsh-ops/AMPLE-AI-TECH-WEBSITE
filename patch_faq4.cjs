...
const newFaq = `function initFaqAccordion() {
    ...
    function resetAll() {
        faqContainers.forEach(container => {
            ...
            if (titleEl) titleEl.style.setProperty('--extracted-tcooor', defaultColors.textColor);
    ...
    faqContainers.forEach(container => {
        ...
        headerPart.addEventListener('click', (e) => {
            ...
            if (titleEl) titleEl.style.setProperty('--extracted-tcooor', activeColors.textColor);
...
console.log('Replaced initFaqAccordion');
